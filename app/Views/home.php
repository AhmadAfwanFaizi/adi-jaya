          ...
          <div class="span12">
            <div class="row">
              <div class="span3">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                    <img src="assets/gambar/_MG_8499.png" class="rounded mx-auto d-block" alt="...">
                  </div>
                  <div class="text">
              ...
              <div class="span3">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                    <img src="assets/gambar/_MG_8513.png" class="rounded mx-auto d-block" alt="...">
                  </div>
                  <div class="text">
              ...
              <div class="span3">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                    <img src="assets/gambar/_MG_8518.png" class="rounded mx-auto d-block" alt="...">
                  </div>
                  <div class="text">
                    <h6>Fresh & Halal</h6>
                    <p>
              ...
              <div class="span3">
                <div class="box aligncenter">
                  <div class="aligncenter icon">
                    <img src="assets/gambar/_MG_8654.png" class="rounded mx-auto d-block" alt="...">
                  </div>
                  <div class="text">
                ...
                <ul id="thumbs" class="portfolio">
                  ...
                  <li class="item-thumbs span3 design" data-id="id-0" data-type="web">
                    ...
                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The City"
                      href="assets/gambar/_MG_8440.png">
                      <span class="overlay-img"></span>
                      <span class="overlay-img-thumb font-icon-plus"></span>
                    </a>
                    <!-- Thumb Image and Description -->
                    <img src="assets/gambar/_MG_8440.png"
                  ...
                  <li class="item-thumbs span3 design" data-id="id-1" data-type="icon">
                    ...
                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Office"
                      href="assets/gambar/_MG_8499.png">
                      <span class="overlay-img"></span>
                      <span class="overlay-img-thumb font-icon-plus"></span>
                    </a>
                    <!-- Thumb Image and Description -->
                    <img src="assets/gambar/_MG_8499.png"
                      alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis." />
                  </li>
                  <!-- End Item Project -->
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span3 photography" data-id="id-2" data-type="illustrator">
                    ...
                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Mountains"
                      href="assets/gambar/_MG_8445.png">
                      <span class="overlay-img"></span>
                      <span class="overlay-img-thumb font-icon-plus"></span>
                    </a>
                    <!-- Thumb Image and Description -->
                    <img src="assets/gambar/_MG_8445.png"
                      alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis." />
                  </li>
                  <!-- End Item Project -->
                  <!-- Item Project and Filter Name -->
                  <li class="item-thumbs span3 photography" data-id="id-2" data-type="illustrator">
                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Mountains"
                      href="assets/gambar/_MG_8469.png">
                      <span class="overlay-img"></span>
                      <span class="overlay-img-thumb font-icon-plus"></span>
                    </a>
                    <!-- Thumb Image and Description -->
                    <img src="assets/gambar/_MG_8469.png"
                      alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis." />
                  </li>
                  <!-- End Item Project -->
                </ul>
            ...
            <div class="row">
              <div class="span12">
                <div style="float: none; text-align: center;">
                  <a class="btn btn-large btn-theme btn-rounded animated shake" href="produk.html">Produk</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="span12">
            ...
            <ul id="mycarousel" class="jcarousel-skin-tango recent-jcarousel clients">
              ...
              <li>
                <a href="#">
                  <img src="assets/img/dummies/clients/client4.png" class="client-logo" alt="" />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="assets/img/dummies/clients/client5.png" class="client-logo" alt="" />
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="assets/img/dummies/clients/client6.png" class="client-logo" alt="" />
                </a>
              </li>
              <li>
                <a href="#">
